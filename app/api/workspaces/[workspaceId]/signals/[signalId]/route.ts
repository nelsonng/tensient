...
export const GET = withErrorTracking("View signal", getHandler);
export const PATCH = withErrorTracking("Update signal", patchHandler);
export const DELETE = withErrorTracking("Delete signal", deleteHandler);
